...
$(function(){
	...
	//通过productId获取对应商品信息的URL
	var infoUrl = "/o2o/shopadmin/getproductbyid?productId="+productId;
	//通过productId获取对应商品类别列表信息的URL
	...
	//获取要编辑的商品的商品信息，并给表单赋值
	function getInfo(id){
		$.getJSON(infoUrl,function(data){
			if(data.success){
				//从返回的JSON中获取product对象，并赋值给表单
				...
				//获取原本的商品类别及当前该店铺的所有商品类别列表
				var optionHtml = '';
				var optionArr = data.productCategoryList;
				var optionSelected = product.productCategory.productCategoryId;
				//生成前端的HTML商品类别列表，并选择编辑当期的商品类别
	...
	/*针对商品详情图控件组，若该控件组的左后一个元素发生变化：上传了图片
